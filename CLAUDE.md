...
フォルダー管理システムは、フォルダーの閲覧と管理、および工事プロジェクトの管理のためのWebインターフェースを提供します。
...
2. **工事プロジェクト管理** - 工事情報の一覧・編集・管理
3. **ガントチャート** - プロジェクトのタイムライン表示

## データ保存場所

- **一般ファイル**: `~/penguin`
- **工事プロジェクト**: `~/penguin/豊田築炉/2-工事`
- **プロジェクト詳細**: `~/penguin/豊田築炉/2-工事/.detail.yaml`