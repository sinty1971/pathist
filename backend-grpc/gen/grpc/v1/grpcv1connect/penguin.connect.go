...
func NewFileServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) FileServiceClient {
	...
	fileServiceMethods := v1.File_v1_penguin_proto.Services().ByName("FileService").Methods()
...
func NewCompanyServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) CompanyServiceClient {
	baseURL = strings.TrimRight(baseURL, "/")
	companyServiceMethods := v1.File_v1_penguin_proto.Services().ByName("CompanyService").Methods()
...
func NewKojiServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) KojiServiceClient {
	baseURL = strings.TrimRight(baseURL, "/")
	kojiServiceMethods := v1.File_v1_penguin_proto.Services().ByName("KojiService").Methods()
