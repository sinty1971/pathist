...
func NewKojiServiceHandler(service *services.KojiService) *KojiService {
	return &KojiService{
		kojiService: service,
	}
}

func (h *KojiService) ListKojies(
	ctx context.Context, req *connect.Request[penguinv1.ListKojiesRequest]) (
	*connect.Response[penguinv1.ListKojiesResponse], error) {
	_ = req // 現状フィルター未対応
...
func (h *KojiService) GetKoji(ctx context.Context, req *connect.Request[penguinv1.GetKojiRequest]) (*connect.Response[penguinv1.GetKojiResponse], error) {
...
func (h *KojiService) UpdateKoji(ctx context.Context, req *connect.Request[penguinv1.UpdateKojiRequest]) (*connect.Response[penguinv1.UpdateKojiResponse], error) {
...
func (h *KojiService) UpdateKojiStandardFiles(ctx context.Context, req *connect.Request[penguinv1.UpdateKojiStandardFilesRequest]) (*connect.Response[penguinv1.UpdateKojiStandardFilesResponse], error) {
	if req.Msg.GetKoji() == nil {
		return nil, connect.NewError(connect.CodeInvalidArgument, errors.New("koji is required"))
	}
