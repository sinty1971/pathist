...
type FileInfo struct {
	...
	ActualPath string `json:"actualPath" yaml:"actual_path" example:"/penguin/豊田築炉/2-工事/2025-0618 豊田築炉 名和工場/工事.xlsx"`
...
func NewFileInfo(paths ...string) (*FileInfo, error) {
	...
	if pathsLen >= 1 {
		fileInfo.ActualPath, err = utils.CleanAbsPath(paths[0])
		if err != nil {
			return nil, err
		}
		osFileInfo, err := os.Stat(fileInfo.ActualPath)
		if err != nil {
			return nil, err
		}
